package com.szywind.wiki;

/**
 * Created by a on 19/07/2017.
 */
...
public class wikiDriver {
    //hadoop的安装目录
    static final String HADOOP_HOME = "/Users/a/hadoop/hadoop-2.7.3";
    //HDFS的临时目录，用来放job1的输出结果，注意这个地址是放到hdfs节点上的地址
    static final String TMP_PATH = "/user/a/tmp/part-r-00000";
